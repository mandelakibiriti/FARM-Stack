...
public class BodyTemperatureObservationContainment extends Containment {
  ...
  public SelectAqlField<NullFlavour> LOCATION_OF_MEASUREMENT_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BodyTemperatureObservation.class, "/protocol[at0020]/items[at0021]/null_flavour|defining_code", "locationOfMeasurementNullFlavourDefiningCode", NullFlavour.class, this);

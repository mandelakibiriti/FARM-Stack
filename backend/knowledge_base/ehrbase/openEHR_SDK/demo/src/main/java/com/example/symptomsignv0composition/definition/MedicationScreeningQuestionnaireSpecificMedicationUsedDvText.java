...
@Generated(
    ...
    date = "2023-06-19T20:52:30.851767138+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
@OptionFor("DV_TEXT")
public class MedicationScreeningQuestionnaireSpecificMedicationUsedDvText implements RMEntity, MedicationScreeningQuestionnaireSpecificMedicationUsedChoice {
  /**
   ...
   */
  @Path("|value")
  private String specificMedicationUsedValue;

  public void setSpecificMedicationUsedValue(String specificMedicationUsedValue) {
     this.specificMedicationUsedValue = specificMedicationUsedValue;
  }

  public String getSpecificMedicationUsedValue() {

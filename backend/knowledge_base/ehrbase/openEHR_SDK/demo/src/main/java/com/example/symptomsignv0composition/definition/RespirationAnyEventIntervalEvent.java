...
@Generated(
    ...
    date = "2023-06-19T20:52:30.811572143+03:00",
...
public class RespirationAnyEventIntervalEvent implements IntervalEventEntity, RespirationAnyEventChoice {
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Respiration/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: clinical encounter.v0/Vital signs/Respiration/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: clinical encounter.v0/Vital signs/Respiration/Any event/sample_count
   */
  @Path("/sample_count")

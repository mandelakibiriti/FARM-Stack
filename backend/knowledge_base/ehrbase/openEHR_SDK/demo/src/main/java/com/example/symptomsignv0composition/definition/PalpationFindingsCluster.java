...
@Generated(
    ...
    date = "2023-06-19T20:52:30.778860118+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
public class PalpationFindingsCluster implements LocatableEntity {
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/System or structure examined
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Tree/Palpation findings/System or structure examined/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour systemOrStructureExaminedNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/Body site
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Tree/Palpation findings/Body site/null_flavour
   */
  @Path("/items[at0012]/null_flavour|defining_code")
  private NullFlavour bodySiteNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/Structured body site
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/No abnormality detected
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Tree/Palpation findings/No abnormality detected/null_flavour
   */
  @Path("/items[at0002]/null_flavour|defining_code")
  private NullFlavour noAbnormalityDetectedNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/Clinical description
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Tree/Palpation findings/Clinical description/null_flavour
   */
  @Path("/items[at0003]/null_flavour|defining_code")
  private NullFlavour clinicalDescriptionNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/Examination findings
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/Multimedia representation
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/Clinical interpretation
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/Comment
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Tree/Palpation findings/Comment/null_flavour
   */
  @Path("/items[at0007]/null_flavour|defining_code")
  private NullFlavour commentNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/Examination not done
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Palpation findings/feeder_audit
   */
  @Path("/feeder_audit")

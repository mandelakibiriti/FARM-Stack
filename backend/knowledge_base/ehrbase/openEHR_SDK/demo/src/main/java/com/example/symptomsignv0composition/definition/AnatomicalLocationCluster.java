...
@Generated(
    ...
    date = "2023-06-19T20:52:30.673287119+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
public class AnatomicalLocationCluster implements LocatableEntity {
  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/Anatomical location/Body site name
  ...
  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/structure/Anatomical location/Body site name/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour bodySiteNameNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/Anatomical location/Specific site
  ...
  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/structure/Anatomical location/Specific site/null_flavour
   */
  @Path("/items[at0065]/null_flavour|defining_code")
  private NullFlavour specificSiteNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/Anatomical location/Laterality
  ...
  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/structure/Anatomical location/Laterality/null_flavour
   */
  ...
  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/structure/Anatomical location/Anatomical Line/null_flavour
   */
  @Path("/items[at0055]/null_flavour|defining_code")
  private NullFlavour anatomicalLineNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/Anatomical location/Description
  ...
  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/structure/Anatomical location/Description/null_flavour
   */
  @Path("/items[at0023]/null_flavour|defining_code")
  private NullFlavour descriptionNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/Anatomical location/Alternative structure
  ...
  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/Anatomical location/Multimedia representation
  ...
  /**
   * Path: clinical encounter.v0/Problem/Diagnosis/Anatomical location/Anatomical Line

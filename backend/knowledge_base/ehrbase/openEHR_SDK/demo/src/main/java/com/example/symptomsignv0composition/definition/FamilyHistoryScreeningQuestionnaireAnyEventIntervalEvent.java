...
@Generated(
    ...
    date = "2023-06-19T20:52:30.840750622+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
@OptionFor("INTERVAL_EVENT")
public class FamilyHistoryScreeningQuestionnaireAnyEventIntervalEvent implements IntervalEventEntity, FamilyHistoryScreeningQuestionnaireAnyEventChoice {
  /**
  ...
  /**
   * Path: clinical encounter.v0/Screening/Family history screening questionnaire/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: clinical encounter.v0/Screening/Family history screening questionnaire/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: clinical encounter.v0/Screening/Family history screening questionnaire/Any event/sample_count
   */
  @Path("/sample_count")

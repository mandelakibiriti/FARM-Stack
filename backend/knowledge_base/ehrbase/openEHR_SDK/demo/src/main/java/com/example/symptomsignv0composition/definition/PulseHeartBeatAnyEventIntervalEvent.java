...
@Generated(
    ...
    date = "2023-06-19T20:52:30.804337421+03:00",
...
public class PulseHeartBeatAnyEventIntervalEvent implements IntervalEventEntity, PulseHeartBeatAnyEventChoice {
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Any event/sample_count
   */
  @Path("/sample_count")

                            ...
                            <div className="bg-white dark:bg-gray-800 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        <h3 className="text-base font-semibold leading-6 text-gray-900 dark:text-white" id="modal-title">Delete {props.data.nameStd}</h3>
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500 dark:text-white">Are you sure you want to delete {props.data.nameStd}? All of the data will be permanently removed. This action cannot be undone.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

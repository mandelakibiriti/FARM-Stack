...
export default function CreateMedicalPlan() {
    ...
    return(
        <div>
            <nav className="fixed shadow-lg w-full bg-background border-slate-300 dark:bg-black navbar">
            ...
            <div className="py-32 lg:py-18 ml-6 flex justify-center">
                <div className="grid lg:grid-cols-2 grid-cols-1">
                            ...
                            <div className="mt-2 mr-6"> 
                                <div className="rounded-lg">
                                    ...
                                    <input 
                                        ...
                                        className="mt-1 mb-8 block w-full border-slate-300 dark:bg-gray-900 dark:text-white dark:border-gray-900 shadow-sm text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 p-3" 
                                        placeholder="Patient Identifier" 
                                    >
                                    </input>
                                    {errors.patient_name && <span className="text-primary-500 font-medium text-sm">This field is required</span>}
                                    ...
                                    {errors.active_diagnosis && <span className="text-primary-500 font-medium text-sm">This field is required</span>}
                                    ...
                                    {errors.icd_10 && <span className="text-primary-500 font-medium text-sm">This field is required</span>}
                                    ...
                                    {errors.notes && <span className="text-primary-500 font-medium text-sm">This field is required</span>}
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div className="flex flex-col lg:mt-0 mt-8 mb-8">
                        ...
                        <div className="rounded-lg h-4/5 lg:h-96 w-11/12 p-4 bg-primary-foreground dark:bg-card border-slate-300 dark:bg-gray-900 dark:border-gray-900 border">

...
@Generated(
    ...
    date = "2023-06-19T20:52:30.830214703+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
public class ProblemDiagnosisQualifierCluster2 implements LocatableEntity {
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Diagnostic status/null_flavour
   */
  @Path("/items[at0004]/null_flavour|defining_code")
  private NullFlavour diagnosticStatusNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Current/Past?
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Current/Past?/null_flavour
   */
  @Path("/items[at0060]/null_flavour|defining_code")
  private NullFlavour currentPastNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Active/Inactive?
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Active/Inactive?/null_flavour
   */
  @Path("/items[at0003]/null_flavour|defining_code")
  private NullFlavour activeInactiveNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Level of control/null_flavour
   */
  @Path("/items[at0098]/null_flavour|defining_code")
  private NullFlavour levelOfControlNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Progression/null_flavour
   */
  @Path("/items[at0102]/null_flavour|defining_code")
  private NullFlavour progressionNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Resolution phase/null_flavour
   */
  @Path("/items[at0083]/null_flavour|defining_code")
  private NullFlavour resolutionPhaseNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Remission status/null_flavour
   */
  @Path("/items[at0089]/null_flavour|defining_code")
  private NullFlavour remissionStatusNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Episodicity/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour episodicityNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Reason for an ongoing episode
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Occurrence/null_flavour
   */
  @Path("/items[at0071]/null_flavour|defining_code")
  private NullFlavour occurrenceNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Course label/null_flavour
   */
  @Path("/items[at0077]/null_flavour|defining_code")
  private NullFlavour courseLabelNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Diagnostic category
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Admission diagnosis?/null_flavour
   */
  @Path("/items[at0073]/null_flavour|defining_code")
  private NullFlavour admissionDiagnosisNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Comment
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Tree/Problem/Diagnosis qualifier/Comment/null_flavour
   */
  @Path("/items[at0110]/null_flavour|defining_code")
  private NullFlavour commentNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Admission diagnosis?
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Progression
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Diagnostic status
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Occurrence
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Level of control
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Course label
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Episodicity
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Remission status
  ...
  /**
   * Path: clinical encounter.v0/Patient progress/Progress note/Problem/Diagnosis qualifier/Resolution phase

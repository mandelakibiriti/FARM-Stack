...
@Entity
@Archetype("openEHR-EHR-CLUSTER.exam-inspection.v0")
@Generated(
    value = "org.ehrbase.client.classgenerator.ClassGenerator",
    date = "2023-06-19T20:52:30.777865912+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
public class InspectionFindingsCluster implements LocatableEntity {
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/System or structure examined
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Tree/Inspection findings/System or structure examined/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour systemOrStructureExaminedNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/Body site
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Tree/Inspection findings/Body site/null_flavour
   */
  @Path("/items[at0012]/null_flavour|defining_code")
  private NullFlavour bodySiteNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/Structured body site
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/No abnormality detected
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Tree/Inspection findings/No abnormality detected/null_flavour
   */
  @Path("/items[at0002]/null_flavour|defining_code")
  private NullFlavour noAbnormalityDetectedNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/Clinical description
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Tree/Inspection findings/Clinical description/null_flavour
   */
  @Path("/items[at0003]/null_flavour|defining_code")
  private NullFlavour clinicalDescriptionNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/Examination findings
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/Multimedia representation
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/Clinical interpretation
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/Comment
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Tree/Inspection findings/Comment/null_flavour
   */
  @Path("/items[at0007]/null_flavour|defining_code")
  private NullFlavour commentNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/Examination not done
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Physical examination findings/Any event/Inspection findings/feeder_audit
   */
  @Path("/feeder_audit")

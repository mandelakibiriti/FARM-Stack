...
@Generated(
    ...
    date = "2023-06-19T20:52:30.770364247+03:00",
...
public class HeightLengthAnyEventIntervalEvent implements IntervalEventEntity, HeightLengthAnyEventChoice {
  ...
  /**
   * Path: clinical encounter.v0/Examination details/Height/Length/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: clinical encounter.v0/Examination details/Height/Length/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: clinical encounter.v0/Examination details/Height/Length/Any event/sample_count
   */
  @Path("/sample_count")

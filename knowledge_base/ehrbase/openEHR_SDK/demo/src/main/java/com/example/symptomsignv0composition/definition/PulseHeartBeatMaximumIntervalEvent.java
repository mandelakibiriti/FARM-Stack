...
@Generated(
    ...
    date = "2023-06-19T20:52:30.800286780+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
public class PulseHeartBeatMaximumIntervalEvent implements IntervalEventEntity {
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/Presence
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/history/Maximum/structure/Presence/null_flavour
   */
  @Path("/data[at0001]/items[at1005]/null_flavour|defining_code")
  private NullFlavour presenceNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/Rate
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/history/Maximum/structure/Rate/null_flavour
   */
  @Path("/data[at0001]/items[at0004]/null_flavour|defining_code")
  private NullFlavour rateNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/Regularity
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/history/Maximum/structure/Regularity/null_flavour
   */
  @Path("/data[at0001]/items[at0005]/null_flavour|defining_code")
  private NullFlavour regularityNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/Irregular type
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/history/Maximum/structure/Irregular type/null_flavour
   */
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/Clinical description
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/history/Maximum/structure/Clinical description/null_flavour
   */
  @Path("/data[at0001]/items[at1022]/null_flavour|defining_code")
  private NullFlavour clinicalDescriptionNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/Clinical interpretation
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/Rhythm
   * Description: Single word, phrase or brief description that represents the clinical meaning and significance of the pulse or heart beat findings, including the rhythm.
   * Comment: Coding with a terminology is preferred, where possible. For example: Bradycardia, Extrasystoles or Sinus rhythm. Multiple statements are allowed.
   */
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/Comment
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/history/Maximum/structure/Comment/null_flavour
   */
  @Path("/data[at0001]/items[at1059]/null_flavour|defining_code")
  private NullFlavour commentNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/Position
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/history/Maximum/List/Position/null_flavour
   */
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/Exertion
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/sample_count
   */
  @Path("/sample_count")
  private Long sampleCount;

  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/width
   */
  @Path("/width|value")
  ...
  /**
   * Path: clinical encounter.v0/Vital signs/Pulse/Heart beat/Maximum/time
   */
  @Path("/time|value")

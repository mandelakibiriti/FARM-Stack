...
@Generated(
    ...
    date = "2023-06-19T20:52:30.846760481+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
@OptionFor("INTERVAL_EVENT")
public class MedicationScreeningQuestionnaireAnyEventIntervalEvent implements IntervalEventEntity, MedicationScreeningQuestionnaireAnyEventChoice {
  /**
  ...
  /**
   * Path: clinical encounter.v0/Screening/Medication screening questionnaire/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: clinical encounter.v0/Screening/Medication screening questionnaire/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: clinical encounter.v0/Screening/Medication screening questionnaire/Any event/sample_count
   */
  @Path("/sample_count")

...
@Generated(
    ...
    date = "2023-06-19T20:52:30.729129903+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
public class SymptomSignResolvingFactorCluster implements LocatableEntity {
  /**
   * Path: clinical encounter.v0/Sign/Symptoms/Symptom/Sign/Any event/Resolving factor/Factor
  ...
  /**
   * Path: clinical encounter.v0/Sign/Symptoms/Symptom/Sign/Any event/Tree/Resolving factor/Factor/null_flavour
   */
  @Path("/items[at0170]/null_flavour|defining_code")
  private NullFlavour factorNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Sign/Symptoms/Symptom/Sign/Any event/Resolving factor/Factor detail
  ...
  /**
   * Path: clinical encounter.v0/Sign/Symptoms/Symptom/Sign/Any event/Resolving factor/Time interval
  ...
  /**
   * Path: clinical encounter.v0/Sign/Symptoms/Symptom/Sign/Any event/Tree/Resolving factor/Time interval/null_flavour
   */
  @Path("/items[at0171]/null_flavour|defining_code")
  private NullFlavour timeIntervalNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Sign/Symptoms/Symptom/Sign/Any event/Resolving factor/Description
  ...
  /**
   * Path: clinical encounter.v0/Sign/Symptoms/Symptom/Sign/Any event/Tree/Resolving factor/Description/null_flavour
   */
  @Path("/items[at0185]/null_flavour|defining_code")
  private NullFlavour descriptionNullFlavourDefiningCode;

  /**
   * Path: clinical encounter.v0/Sign/Symptoms/Symptom/Sign/Any event/Resolving factor/feeder_audit
   */
  @Path("/feeder_audit")

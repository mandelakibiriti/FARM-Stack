...
@Generated(
    ...
    date = "2023-06-19T20:52:30.865780408+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
@OptionFor("DV_TEXT")
public class DiagnosticInvestigationScreeningQuestionnaireAnyTestsDvText implements RMEntity, DiagnosticInvestigationScreeningQuestionnaireAnyTestsChoice {
  /**
   ...
   */
  @Path("|value")
  private String anyTestsValue;

  public void setAnyTestsValue(String anyTestsValue) {
     this.anyTestsValue = anyTestsValue;
  }

  public String getAnyTestsValue() {

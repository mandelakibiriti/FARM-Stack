...
@Generated(
    ...
    date = "2023-06-19T20:52:30.698575062+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
@OptionFor("DV_TEXT")
public class ProblemDiagnosisQualifierDiagnosticCategoryDvText implements RMEntity, ProblemDiagnosisQualifierDiagnosticCategoryChoice {
  /**
   ...
   */
  @Path("|value")
  private String diagnosticCategoryValue;

  public void setDiagnosticCategoryValue(String diagnosticCategoryValue) {
     this.diagnosticCategoryValue = diagnosticCategoryValue;
  }

  public String getDiagnosticCategoryValue() {
     return this.diagnosticCategoryValue ;
  }
}
